...
> ˼🤖˹↜ الــبــوت↶
╮───────────────────⟢ـ
┆⚙️ ↜اسـم الـبـوت↶﹝GØKÀR﹞
┆🪄 ↜الـمـطـور ↶﹝ASHŘÀF﹞
┆📌 ↜الـتـشـغـيـل ﹝uptime}﹞
┆🔖 ↜الــمــســتـخـدمـيـن ↶﹝rtotg}﹞
╯───────────────────⟢ـ
> ©  𝑮𝑶𝑲𝑨𝑹 2025`,subtitle: "GOKAR",},header: { hasMediaAttachment: true,...(await prepareWAMessageMedia({ image : { url: zack } }, { upload: conn.waUploadToServer }, {quoted: m}))},
                    contextInfo: {
                        ...
                        isForwarded: false,
...

                            {
                                ...
                                buttonParamsJson: JSON.stringify({
                                    ...
                                    sections: [
                                        {
                                            title: 'مــرحـ🛡ـبــا بــك فـي مــ☑هــام جوكر بـ🤖ـوت',
                                            highlight_label: 'GOKAR',
                                            rows: [
                                                {
                  ...
                  messageParamsJson: ''
                     ...
                     {
               name: "cta_url",
               buttonParamsJson: '{"display_text":"⌈📲╎قـنـاة الــبــوت╎📲⌋","url":"https://chat.whatsapp.com/IOpmTF3woFb7015KsX1INw","merchant_url":""}'
                            }
                        ]
                    }
                }
